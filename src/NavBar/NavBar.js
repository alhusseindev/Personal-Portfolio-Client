        ...
        <nav className="nav__bar">
            ...
            <div className="menu__icon">
                ...
                <ul className="header-list">
                    <li className="header-points"><a className="header__links" href="https://drive.google.com/file/d/1xPR4ghXwoYDYXGjuiPFJd0aIDvI60JqK/view?usp=sharing" target="_blank" rel="noreferrer">Resume</a></li>
