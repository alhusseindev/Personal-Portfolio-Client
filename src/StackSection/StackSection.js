...
const StackSection = () =>{
    return(
        <section className="stack-section">
            <h1 className="stack-section-hero">My Tech Stack</h1>
            <div className="stack-container">
                <div className="stack"><h3 className="languages">C</h3></div>
                <div className="stack"><h3 className="languages">C++</h3></div>
                <div className="stack"><h3 className="languages">Java</h3></div>
                <div className="stack"><h3 className="languages">Python</h3></div>
                <div className="stack"><h3 className="languages">JavaScript</h3></div>
                ...
                <div className="stack"><h3 className="languages">Django</h3></div>
                ...
                <div className="stack"><h3 className="languages">Pandas & NumPy</h3></div>
                <div className="stack"><h3 className="languages">MySQL</h3></div>
                <div className="stack"><h3 className="languages">MongoDB</h3></div>
                <div className="stack"><h3 className="languages">SQLite</h3></div>
                <div className="stack"><h3 className="languages">Git</h3></div>
                <div className="stack"><h3 className="languages">GitHub</h3></div>
                <div className="stack"><h3 className="languages">Linux/Unix</h3></div>
                <div className="stack"><h3 className="languages">Cloud</h3></div>
                <div className="stack"><h3 className="languages">AWS</h3></div>
                <div className="stack"><h3 className="languages">Docker</h3></div>
                <div className="stack"><h3 className="languages">Computer Networks</h3></div>
                <div className="stack"><h3 className="languages">Cyber Security</h3></div>
                <div className="stack"><h3 className="languages">Network Security</h3></div>
